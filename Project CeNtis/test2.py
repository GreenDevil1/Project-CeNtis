...
# --------------------------------------------introduction containing program information-----------------------------------------------------
    ...
    print(Fore.BLACK+"_____________________________________________"+Fore.RED+"Created by: "+Style.BRIGHT+Fore.LIGHTRED_EX+"GreenTee"+Style.BRIGHT+Fore.LIGHTMAGENTA_EX+"(Gr33T)"+Style.BRIGHT+Style.RESET_ALL)
    ...
    print(Fore.BLACK+"_________________"+Style.BRIGHT+Fore.BLACK+"Visit https://kekonetwothreesilkroadkek.com/bios/alt+f4/loop to update all your tools!"+Style.RESET_ALL)
    print("")
    print("")
...
# ---------------------------------------------------------Download mp4 and mp3----------------------------------------------------------------              
                        ...
                        print("")
                        print("options: ")
                        print("  1) two different directories")
                        print("  2) same directory")
...
# ----------------------------------------------------------Start Phonetracker-------------------------------------------------------------------
                ...
                if frage3 == "1":
                        ...
                        Key = "515266db27d044f5bd30a311091f3782"
